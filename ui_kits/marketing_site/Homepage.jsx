    ...
    <div className="site">
      ...
      <section className="section tint" id="services">
        <div className="container">
          ...
          <div className="grid-3 mt-56">
            <FeatureCard icon={Ic.messages({ size: 26 })} title="Debt Negotiation"
            ...
            <FeatureCard tone="green" icon={Ic.fileCheck({ size: 26 })} title="Debt Settlement"
      ...
      <section className="section">
        <div className="container">
          <div className="band-media">
            <image-slot id="drp-band" shape="rounded" radius="24" placeholder="Drop a wide office / team photo"></image-slot>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="footer-bottom">
            ...
            <span className="footer-legal">
              <a href="#">Copyright</a><a href="#">Privacy Policy</a><a href="#">Terms of Service</a>
            </span>
          </div>
        </div>
      </footer>
